...
return (
    <>
    <div className="overflow-hidden bg-gray-color">
        <div className="relative max-w-[85rem] lg:py-4 mx-auto flex justify-center">
            <div className="grid lg:grid-cols-3 gap-6 card-contain">
            <div className="flex h-auto">
                <CardTestimonials 
                coment={testimonials[0].text}
                img={testimonials[0].image}
                people={testimonials[0].name}
                role={testimonials[0].role}
                />
            </div>
            <div className="flex h-auto">
                <CardTestimonials 
                coment={testimonials[1].text}
                img={testimonials[1].image}
                people={testimonials[1].name}
                role={testimonials[1].role}
                />
            </div>
            <div className="flex h-auto">
                <CardTestimonials
                coment={testimonials[2].text}
                img={testimonials[2].image}
                people={testimonials[2].name}
                role={testimonials[2].role} />
            </div>
        </div>

    <div className="absolute bottom-0 end-0 transform lg:translate-x-32" aria-hidden="true">
      <svg className="w-40 h-auto sm:w-72 z-[-1]" width="1115" height="636" viewBox="0 0 1115 636" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const testimonials = [
  {
    image: "https://www.ensalza.com/blog/wp-content/litespeed/avatar/bd5c1c06b44110fbe6de38ab4aacf0c9.jpg?ver=1727339454", 
    name: "Juan Pérez",
    text: "La academia ha sido increíble para mi carrera profesional. Los instructores son muy capacitados y el material de estudio es de alta calidad. Sin duda, lo recomendaría a todos.",
    role: 'Dev Full Stack Python'
  },
  {
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwNpoWSi1dRcZYTrlzbPb0zmfhh5SBbG2fFg&s",
    name: "María Gómez",
    text: "He aprendido muchísimo en poco tiempo. El contenido está bien estructurado y el soporte de los tutores es excelente. Estoy más que satisfecha con lo que he logrado hasta ahora.",
    role: 'Dev Ops'
  },
  {
    image: "https://img.freepik.com/foto-gratis/worldface-hombre-espanol-fondo-blanco_53876-139733.jpg",
    name: "Carlos Rodríguez",
    text: "Los cursos están diseñados de una manera muy didáctica y fácil de entender. La flexibilidad para estudiar a mi propio ritmo ha sido clave para equilibrar mi trabajo y estudio.",
